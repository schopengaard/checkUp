@extends('layouts.app')
@section('title', 'Past Appointment Page')
...
<div class="container mt-4">
	<div class="row justify-content-center">
		...
		@include('partials._admintabs', array([$tab[0]=''], [$tab[1]=''], [$tab[2]=''], [$tab[3]='active'], [$tab[4]=''], [$tab[5]='']))
	</div>
</div>
@endsection
...
<div class="row col-sm-12 px-0 mx-0 mb-3">
	<div class="flex-grow-1">
		<form action="{{ action('AdminController@search_past_appointment') }}" method="get">
			<div class="input-group">
				<input type="text" name="search_past_appointment" class="form-control" placeholder="Search Appointments" aria-label="Search Appointments" aria-describedby="basic-addon2">
