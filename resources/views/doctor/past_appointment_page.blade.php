...
<div class="container mt-4">
	<div class="row justify-content-center">
		...
		@include('partials._doctortabs', array([$tab[0]=''], [$tab[1]='active'], [$tab[2]=''], [$tab[3]='']))
	</div>
</div>
@endsection
	...
	<table class="table table-sm table-hover tableBack mb-0">
		...
		<tbody>
			...
			<tr>
				...
				<td>{{ $row->bill_id }}</td>
				<td class="text-right">
					@include('partials._dropdown', array([$drop[0]='DoctorController@show_past_appointment'], [$drop[1]='DoctorController@edit_appointment'], [$drop[2]='DoctorController@destroy_appointment']))
				</td>
			</tr>
			@endforeach
		</tbody>
